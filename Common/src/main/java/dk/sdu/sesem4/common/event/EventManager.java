...
public class EventManager {
     ...
     *
     * @param type EventType that is to be subscribed to. It must be a subclass.
     ...
     *
     * @param type EventType that is to be unsubscribed from. It must be a subclass.
     ...
     *
     * @param type EventType of the notification. This will decide which subscribers the notification is sent to.
